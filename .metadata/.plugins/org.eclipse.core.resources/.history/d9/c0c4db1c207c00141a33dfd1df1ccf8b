...
_iir_single:
	...
	[A1]	SUB		.L1		A12, 11, A12 	;;check if counter is 11, if so, subtract filter order to reset
		...
		ADD		.S2		B1,10,B1			;;initialize the k counter value to 10
LOOP:
		SUB		.S2		B9, B1, B6			;;store difference of loop counter to register B6 (i = n - k)
...
NO_WRAP:
	...
	[B1]	B		.S2		LOOP
		...
		SUB		.S1x	A4, B12, A11		;;subtract sum from current reading in A4
		STW		.D1		A11, *A7[A12]
		NOP		5
